...
from  PctureClass import Picture
from tkinter import filedialog, simpledialog, Toplevel, Label, Entry, Button, StringVar, OptionMenu, ttk
from tkinter.filedialog import asksaveasfilename
from PIL import Image, ImageTk
import os
import json
from Util import move_image, rotate_image, Bring_File_path, load_panel_names, open_alpha_form  # Import the move_image function
...
def select_panel_name():
    ...
    panel_combobox = ttk.Combobox(panel_window, textvariable=selected_panel_name, values=panel_names)
...
def add_image():
    ...
    if current_image_path:
        ...
        if file_path:
            ...
            # Open the alpha form
            open_alpha_form(root,new_image_position, disp_rotation_angle, picture, f"{width}x{height}")
...
add_button = tk.Button(root, text="Add Image", command=add_image, state=tk.DISABLED)
